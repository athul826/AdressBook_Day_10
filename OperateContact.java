...
public class OperateContact{
    ...
    HashMap<String, AdressBook> contactMap = new HashMap<>();
    ...
    public void editContact(){
        ...
        {
            AdressBook contact = contactMap.get(firstName);
    ...
    public void storeContact(String firstName, AdressBook contact){
